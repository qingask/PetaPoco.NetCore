...
namespace PetaPoco.NetCore
{
    ...
    {
        public  DatabaseType GetDatabaseType(string providerName)
        {
            switch (providerName)
            {
        ...
        /// <summary>
        /// SqlConnectionFactory.cs 创建DB连接的
        /// </summary>
        public  DbConnection CreateSqlConnection(string providerName, string connectionStr)
        {
            DbConnection connection = null;
            var dataType = GetDatabaseType(providerName);
            switch (dataType)
            {
    ...
    public class Database : IDisposable
    {
        ...
        public Database(string connectionStringName)
        {
            ...
            _connectionString = Configuration[string.Format("ConnectionStrings:{0}", connectionStringName)];
#else
            if (connectionStringName == "")
        ...
        public void OpenSharedConnection()
        {
            ...
            {
#if COREFX
                _sharedConnection = new SqlConnectionFactory().CreateSqlConnection(_providerName, _connectionString);
#else
